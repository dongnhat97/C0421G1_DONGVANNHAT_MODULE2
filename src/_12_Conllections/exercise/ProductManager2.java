...
public class ProductManager2 {
    ...
    public static void main(String[] args) {
        ...
        Product product1 = new Product(1, "Giay", 15000);
        Product product2 = new Product(2, "Dep", 20000);
        Product product3 = new Product(3, "Ao", 25500);
        Product product4 = new Product(4, "Quan", 30000);
        // Thêm sản phẩm
